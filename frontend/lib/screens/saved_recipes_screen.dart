...
class _SavedRecipesScreenState extends State<SavedRecipesScreen> {
  ...
  Future<void> unsaveRecipe(String recipeId) async {
    final url = Uri.parse(
      'http://192.168.0.103:3000/api/users/${widget.userId}/unsaveRecipe',
    );
    await http.post(
      url,
  ...
  Future<void> deleteRecipe(String recipeId) async {
    final url = Uri.parse('http://192.168.0.103:3000/api/recipes/$recipeId');
  ...
  Widget _buildRecipeCard(Map recipe) {
    ...
    if (image != null && image.startsWith('http')) {
      ...
      imageProvider = NetworkImage('http://192.168.0.103:3000/images/$image');
    } else {
