...
class _MyRecipesScreenState extends State<MyRecipesScreen> {
  ...
  Future<void> fetchUserRecipes() async {
    final url = Uri.parse(
      'http://192.168.0.101:3000/api/users/${widget.userId}/myRecipes',
    );
  ...
  Future<String> translateToArabic(String text) async {
    ...
    try {
      final response = await http.post(
        Uri.parse(
          'http://192.168.0.101:3000/translate',
                          ...
                          onPressed: () async {
                            ...
                            try {
                              final res = await http.post(
                                Uri.parse(
                                  'http://192.168.0.101:3000/api/analyze-nutrition',
                                ),
                                headers: {'Content-Type': 'application/json'},
                                body: jsonEncode({
                                  'title': title,
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    final res = await http.put(
                      Uri.parse(
                        'http://192.168.0.101:3000/api/recipes/${recipe['_id']}',
                      ),
                      headers: {'Content-Type': 'application/json'},
              ...
              actions: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    final res = await http.post(
                      Uri.parse(
                        'http://192.168.0.101:3000/api/users/${widget.userId}/customRecipe',
                      ),
                      headers: {'Content-Type': 'application/json'},
                      body: jsonEncode(body),
                    );
