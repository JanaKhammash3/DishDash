          ...
          child: Column(
            ...
            children: [
                ...
                child: ListView(
                  ...
                  children: [
                    placeCard(
                      'VEGAN BURGER',
                      'By GreenEats',
                      'assets/images/vegan_burger.png',
                    ),
                    placeCard(
                      'BERRY PARFAIT',
                      'By SweetHeaven',
              ...
              Row(
                ...
                children: [
                  popularCard('PASTA BAKE', 'assets/images/pasta.png'),
                  popularCard('AVO TOAST', 'assets/images/avocado_toast.png'),
                ],
              ),
            ],
          ),
      ...
      bottomNavigationBar: Padding(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: Colors.black.withValues(alpha: 25), // ~0.1 * 255
                blurRadius: 10,
          ...
          child: Row(
            ...
            children: [
              ...
              bottomNavItem(Icons.bookmark, 'Saved'),
