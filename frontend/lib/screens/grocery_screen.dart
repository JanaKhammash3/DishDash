...
class _GroceryScreenState extends State<GroceryScreen> {
  ...
  Future<void> _loadIngredients() async {
    final url = Uri.parse(
      'http://192.168.0.101:3000/api/mealplans/user/${widget.userId}/grocery-list',
    );
  ...
  Future<void> _loadAvailableIngredients() async {
    final url = Uri.parse(
      'http://192.168.0.101:3000/api/users/${widget.userId}/available-ingredients',
    );
  ...
  Future<void> recordPurchase(String storeId, String ingredient) async {
    final url = Uri.parse(
      'http://192.168.0.101:3000/api/stores/$storeId/purchase',
    );
  ...
  void _showStoreSelection(String itemName) async {
    final url = Uri.parse(
      'http://192.168.0.101:3000/api/stores?item=${Uri.encodeComponent(itemName)}',
    );
    final response = await http.get(url);
...
class _StorePriceScreenState extends State<StorePriceScreen> {
  ...
  Future<void> fetchStorePrices() async {
    final url = Uri.parse(
      'http://192.168.0.101:3000/api/stores?item=${Uri.encodeComponent(widget.itemName)}',
    );
